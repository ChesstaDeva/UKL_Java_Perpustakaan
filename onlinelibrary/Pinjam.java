...
public class Pinjam {
    ...
    //list pinjaman
    public void pinjamSiswa(Siswa siswa, Buku buku){
    ...
    //tambah peminjaman
    public void pinjamSiswa(int idSiswa, int idBuku, int banyak){
    ...
    public void prosesPinjam(int idSiswa, Siswa siswa, Buku buku){
        ...
        pinjamSiswa(idSiswa, idBuku, banyak);
